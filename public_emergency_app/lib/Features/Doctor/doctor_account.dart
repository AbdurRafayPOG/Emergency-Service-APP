...
class DoctorAccountPage extends StatefulWidget {
  const DoctorAccountPage({Key? key}) : super(key: key);
...
class _DoctorAccountPageState extends State<DoctorAccountPage> {
    ...
    try {
      ...
      if (snapshot.value != null) {
        ...
        setState(() {
          ...
          _profession = data['Profession']?.toString() ?? 'Not Available';
  ...
  // Helper to get display name with Dr. prefix
  String get _displayName {
    if (_userName == 'Not Available' || _userName.isEmpty) return 'Doctor';
    return 'Dr. $_userName';
  }
          ...
          : SingleChildScrollView(
              child: Column(
                children: [
                    ...
                    child: Container(
                      ...
                      child: Stack(
                        children: [
                          ...
                          // Username with Dr. prefix and Profession - Centered
                          Center(
                            child: Column(
                              mainAxisSize: MainAxisSize.min,
                              children: [
                  ...
                  // Order: Full Name → Profession → Email → Phone Number
                  // ============================================================
                  Padding(
                    ...
                    child: Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          // Info items - REORGANIZED ORDER: Full Name → Profession → Email → Phone
                          Padding(
